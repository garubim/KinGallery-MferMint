...
contract KinGallery is AccessControl, ReentrancyGuard, Pausable {
    ...
    uint256 public mintPrice = 300_000_000_000_000; // 0.0003 ETH
    ...
    function payAndMint(
        ...
        require(artistContract != ADDRESS_ZERO, "Invalid contract");
        ...
        require(artistPayee != ADDRESS_ZERO, "Invalid artist");
        ...
        // Calculate remaining for minting
